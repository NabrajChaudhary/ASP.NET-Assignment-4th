...
Inherits="BootstrapApp.WebForm2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    <title>Create Account|Learn Free Online</title>
  ...
  <body>
    <section class="loginPage">
      <div class="container">
        <div class="pt-5">
            <h4 class="text-bold text-white text-center py-2 ">
          Welcome to Learn Free Olnine
          <br />
          Account
        </h4>
        </div>
        <div class="row d-flex justify-content-center align-items-center py-0">
          <div class="col-md-6 mt-1">
            ...
            <div class="text-white text-center my-3">
              ...
              <a class="text-primary" href="Login.aspx">Login</a>
            </div>
          </div>
        </div>
      </div>
